...
module.exports = {
    ...
    options: [{
        ...
        name: 'stats',
        description: "Stats de l'accessoire sous forme nom/vie/endurance/attaque/defense/vitesse",
        required: true,
    }],
    async execute(interaction) {
        ...
        try {
            ...
            const statsExistantes = await StatisticsAccessory.findOne({ where: { accessory_id: accessory.id } });
            if (statsExistantes) {
            ...
            console.error(error);
            await interaction.reply("Il y a eu une erreur lors de la création de l'accessoire.");
        }
    }
};