...
const StatisticsPet = require("./statistics_pet")(sequelize);
...
Pet.hasMany(StatisticsPet, { foreignKey: 'pet_id', as: 'statistics_pet' });
StatisticsPet.belongsTo(Pet, { foreignKey: 'pet_id' });
